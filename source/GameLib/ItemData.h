...
//#endif
		...
		enum EItemType
		{
			...
			ITEM_TYPE_MATERIAL,				// 5 ~ 6
			ITEM_TYPE_SPECIAL,				// 6 ~ 7
			ITEM_TYPE_TOOL,					// 7 ~ 8
			ITEM_TYPE_LOTTERY,				// 8 ~ 9
			ITEM_TYPE_ELK,					// 9 ~ 10
			ITEM_TYPE_METIN,				// 10 ~ 11
			ITEM_TYPE_CONTAINER,			// 11 ~ 12
			...
			ITEM_TYPE_POLYMORPH,			// 19 ~ 20
			ITEM_TYPE_TREASURE_BOX,			// 20 ~ 21
			ITEM_TYPE_TREASURE_KEY,			// 21 ~ 22
			ITEM_TYPE_SKILLFORGET,			// 22 ~ 23
			ITEM_TYPE_GIFTBOX,				// 23 ~ 24
			ITEM_TYPE_PICK,					// 24 ~ 25
			ITEM_TYPE_HAIR,					// 25 ~ 26
			ITEM_TYPE_TOTEM,				// 26 ~ 27
			ITEM_TYPE_BLEND,				// 27 ~ 28
			ITEM_TYPE_COSTUME,				// 28 ~ 29
			ITEM_TYPE_DS,					// 29 ~ 30
			ITEM_TYPE_SPECIAL_DS,			// 30 ~ 31
			ITEM_TYPE_EXTRACT,				// 31 ~ 32
			ITEM_TYPE_SECONDARY_COIN,		// 32 ~ 33
			ITEM_TYPE_RING,					// 33 ~ 34
			ITEM_TYPE_BELT,					// 34 ~ 35

			ITEM_TYPE_PET = 35,				//35

			ITEM_TYPE_MEDIUM = 36,			//36
			ITEM_TYPE_GACHA = 37,			//37
			ITEM_TYPE_SOUL = 38,			//38
...
// #endif
			USE_SELECT_ATTRIBUTE,		// 33
			USE_FLOWER,					// 34
// #if defined(ENABLE_SET_CUSTOM_ATTRIBUTE_SYSTEM)
			USE_SET_CUSTOM_ATTRIBUTE,
// #endif
		};
/* Note
* This enum must be the same size and order as the EUseSubTypes
* @ Source/Client/GameLib/ItemData.h
* @ Source/Server/common/item_length.h
* @ Source/Server/db/ProtoReader.cpp
*/
...
#endif
// NEW_CONFIGS
			ITEM_ANTIFLAG_PET			= (1 << 19),	// unk	DEFINE > ENABLE_GROWTH_PET_SYSTEM
			ITEM_ANTIFLAG_QUICKSLOT		= (1 << 20),	// [OK]
			ITEM_ANTIFLAG_CHANGELOOK	= (1 << 21),	// >>	DEFINE > ENABLE_CHANGELOOK_SYSTEM
			ITEM_ANTIFLAG_REINFORCE		= (1 << 22),	// [OK], USE_ADD_ATTRIBUTE
			ITEM_ANTIFLAG_ENCHANT		= (1 << 23),	// [OK], USE_CHANGE_ATTRIBUTE
			ITEM_ANTIFLAG_ENERGY		= (1 << 24),	// [OK]
			ITEM_ANTIFLAG_PETFEED		= (1 << 25),	// [OK], ENABLE_GROWTH_PET_SYSTEM
			ITEM_ANTIFLAG_APPLY			= (1 << 26),	// [OK], Used by custom items like Jolla
			ITEM_ANTIFLAG_ACCE			= (1 << 27),	// [OK], ENABLE_ACCE_COSTUME_SYSTEM
			ITEM_ANTIFLAG_MAIL			= (1 << 28),	// [OK]
// NEW_CONFIGS
		};
		...
		enum EApplyTypes
		{
			...
			APPLY_ATTBONUS_STONE			= 99,	//99
			APPLY_ATTBONUS_BOSS				= 100,	//100
#endif
