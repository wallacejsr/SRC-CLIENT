...
class CActorInstance : public IActorInstance, public IFlyTargetableObject
{
	...
	public:
		...
		bool GetActorImmuneBossState();
		void SetActorImmuneBossState(bool bIsImmuneBoss);
#endif
...
#ifdef __ENABLE_SHAMAN_ATTACK_SPEED_FIX_MAJESTE__
...
#ifdef ENABLE_ASLAN_BUFF_NPC_SYSTEM_STOP_COLLISION
	public:
		void SetBuff(DWORD dwVnum)
		{
			m_eBuff = dwVnum;
		}
