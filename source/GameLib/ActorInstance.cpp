...
bool CActorInstance::GetActorImmuneBossState()
{
	return m_bIsImmuneBoss;
}

void CActorInstance::SetActorImmuneBossState(bool bIsImmuneBoss)
{
	m_bIsImmuneBoss = bIsImmuneBoss;
}
#endif
