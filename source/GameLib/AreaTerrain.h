...
class CTerrain : public CTerrainImpl, public CGraphicBase
{
	public:
		...
		BOOL						IsSafety() { return m_bSafety; }
		void						AllocateSafeSplats(BYTE * pbyAlphaMap);
		void						DeallocateSafeSplats();
		TTerrainSplatPatch &		GetSafeSplatPatch() { return m_SafeSplatPatch; }
#endif
...
#ifdef ENABLE_BATTLE_ROYALE
		BOOL					m_bSafety;
		TTerrainSplatPatch		m_SafeSplatPatch;
		LPDIRECT3DTEXTURE8		m_lpSafetyTexture;
#endif
