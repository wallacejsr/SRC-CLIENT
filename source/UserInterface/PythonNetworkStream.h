...
class CPythonNetworkStream : public CNetworkStream, public CSingleton<CPythonNetworkStream>
{
	...
	public:
		...
		void StartGame();
		bool IsLoadingPhase() { return (m_strPhase == "Loading"); }	// fix Bug duplicar items
		...
		bool SendAttackPacket(UINT uMotAttack, DWORD fake1, DWORD fake2, DWORD dwVIDVictim, DWORD fake3);
#else
	...
	protected:
		...
		bool RecvChatPacket();
		bool RecvLocaleChatPacket(); //_novo_locale_string
	...
	public:
		bool SendDailyGift(BYTE bAction, BYTE bSlotIndex);
	...
	public:
		bool DirectEnterMode_IsSet() { return __DirectEnterMode_IsSet(); }	// fix Bug duplicar items
	...
	public:
		bool SendRankingListPacket(BYTE byValue);
		bool RecvRankingListPacket();
#endif

#if defined(ENABLE_SET_CUSTOM_ATTRIBUTE_SYSTEM)
	public:
		bool SendSetCustomAttribute(const TItemPos TargetPos, const DWORD ApplyNumList[]);

	protected:
		bool RecvAttributesBySet();
#endif
