...
/////////////////////////////////////////////////////////////
void CInstanceBase::__AttachSelectEffectJinno()
{
	__EffectContainer_AttachEffect(EFFECT_JINNO);
}
void CInstanceBase::__DetachSelectEffectJinno()
{
	__EffectContainer_DetachEffect(EFFECT_JINNO);
}
void CInstanceBase::__AttachTargetEffectJinno()
{
	__EffectContainer_AttachEffect(EFFECT_TARGET_JINNO);
}
void CInstanceBase::__DetachTargetEffectJinno()
{
	__EffectContainer_DetachEffect(EFFECT_TARGET_JINNO);
}
/////////////////////////////////////////////////////////////
#endif
