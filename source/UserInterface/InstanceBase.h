...
class CInstanceBase
{
	...
	public:
		...
		enum
		{
			...
			EFFECT_BODYARMOR_PURPLE,
			EFFECT_BODYARMOR_ORANGE,
			EFFECT_BODYARMOR_BLACK,
			EFFECT_BODYARMOR_RED,
#endif

#ifdef USE_BODY_COSTUME_WITH_EFFECT
			EFFECT_BODYARMOR_COSTUME,
#endif

#ifdef BODY_COSTUME_WITH_EFFECT_IMPERIAL
			EFFECT_BODYARMOR_COSTUME_IMPERIAL,
#endif

#ifdef WEAPON_COSTUME_CHRISTMAS_EFFECT
			EFFECT_SWORD_CHRISTMAS = 50,
			EFFECT_DAGGER_CHRISTMAS = 51,
			EFFECT_BOW_CHRISTMAS = 52,
			EFFECT_TWOHAND_CHRISTMAS = 53,
			EFFECT_BELL_CHRISTMAS = 54,
			EFFECT_FAN_CHRISTMAS = 55,
			EFFECT_DAGGER_CHRISTMAS_LEFT = 56,
			EFFECT_FAN_CHRISTMAS_LEFT = 57,
#endif
	...
	public:
		...
		void					SetInstanceImmuneBoss(bool bIsImmuneBoss);
#endif
	...
	protected:
		...
		void __AttachTargetEffectJinno();
		void __DetachTargetEffectJinno();
		void __AttachSelectEffectJinno();
		void __DetachSelectEffectJinno();
#endif
...
#ifdef WEAPON_COSTUME_CHRISTMAS_EFFECT
		DWORD					m_swordRefineEffectChristmasRight;
		DWORD					m_swordRefineEffectChristmasLeft;
#endif
