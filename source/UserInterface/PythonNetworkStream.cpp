...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		CMainPacketHeaderMap()
		{
			...
			Set(HEADER_CG_RANKING_LIST, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketCGRankingListInfo), STATIC_SIZE_PACKET));
			Set(HEADER_GC_RANKING_LIST, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCRankingListInfo), STATIC_SIZE_PACKET));
			#endif
			...
			Set(HEADER_GC_DAILY_GIFT, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCDailyGift), STATIC_SIZE_PACKET));
			#endif
			...
			Set(HEADER_GC_BUFF_NPC_ACTION, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCBuffNPCAction), STATIC_SIZE_PACKET));
			Set(HEADER_GC_BUFF_NPC_USE_SKILL, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCBuffNPCUseSkill), STATIC_SIZE_PACKET));
			#endif
			#ifdef ENABLE_BATTLE_ROYALE
			Set(HEADER_GC_BATTLE_ROYALE, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCBRSafeZone), STATIC_SIZE_PACKET));
			#endif
			...
			Set(HEADER_GC_ATTRIBUTES_BY_SET, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCAttributesBySet), DYNAMIC_SIZE_PACKET));
			#endif
