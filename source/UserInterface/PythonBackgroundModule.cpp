...
PyObject * backgroundVisibleSafeArea(PyObject * poSelf, PyObject * poArgs)
{
	CPythonBackground & rkBG = CPythonBackground::Instance();
	//rkBG.ClearSafeArea();

	//60700 66800 63700 69800
	
	/*
	rkBG.RegisterSafeArea(60000,
		60000,
		70000,
		70000);
	*/

	rkBG.VisibleSafeArea();

	return Py_BuildNone();
}

PyObject * backgroundDisableSafeArea(PyObject * poSelf, PyObject * poArgs)
{
	CPythonBackground::Instance().DisableSafeArea();
	return Py_BuildNone();
}
#endif
...
#endif
#ifdef ENABLE_BATTLE_ROYALE
		{ "VisibleSafeArea",					backgroundVisibleSafeArea,					METH_VARARGS },
		{ "DisableSafeArea",					backgroundDisableSafeArea,					METH_VARARGS },
#endif
