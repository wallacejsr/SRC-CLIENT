...
class CGraphicTextInstance
{
	...
	public:
		...
		void DisableDynamicFont(const bool bFlag) { m_bDisableDynamicFont = bFlag; }
		bool IsDisableDynamicFont() const { return m_bDisableDynamicFont; }
#endif
...
#ifdef ENABLE_DYNAMIC_FONT
		static void AddTextInstance(CGraphicTextInstance* t);
		static void RemoveTextInstance(const CGraphicTextInstance* t);
		static void ReloadTextInstance(CGraphicText* pkDefaultFont);

		static std::list<CGraphicTextInstance*> l_graphicTextInstance;
#endif
};
